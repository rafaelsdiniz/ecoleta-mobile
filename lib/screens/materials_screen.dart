...
class _MaterialsScreenState extends State<MaterialsScreen> {
                      ...
                      return Card(
                        ...
                        child: InkWell(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                // Ícone pequeno com imagem Base64 ou ícone padrão
                                Container(
                                  width: 48,
                                  height: 48,
                                  ...
                                  child: _buildMaterialIcon(material),
                                ),
  ...
  Widget _buildMaterialIcon(mat.Material material) {
    // Se tem imagem Base64, exibe como ícone pequeno
    if (material.imagemBase64 != null && material.imagemBase64!.isNotEmpty) {
      try {
        final bytes = _decodeBase64(material.imagemBase64!);
        return ClipRRect(
          borderRadius: BorderRadius.circular(12),
          child: Image.memory(
            bytes,
        ...
        print('Error decoding base64 for material: $e');
        return _buildDefaultIcon();
      }
    }
    
    // Se tem URL de imagem, também exibe como ícone pequeno
    if (material.nomeImagem != null && material.nomeImagem!.isNotEmpty) {
      return ClipRRect(
        borderRadius: BorderRadius.circular(12),
        child: Image.network(
          material.imageUrl,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Ícone do material na tela de detalhes (também pequeno)
                    Center(
                      child: Container(
                        width: 80,
                        height: 80,
