...
class _HomeScreenState extends State<HomeScreen> {
  ...
  static const CameraPosition _initialPosition = CameraPosition(
    target: LatLng(-10.184444, -48.333889), // Palmas, TO
    zoom: 13.0,
  );
  ...
  Future<void> _loadPontosColeta() async {
    ...
    try {
      ...
      print('[v0] Error loading pontos: $e');
      setState(() {
        _isLoadingPontos = false;
      });
    }
        ...
        _markers.add(
          Marker(
            ...
            infoWindow: InfoWindow(
              title: ponto.nome,
              snippet: ponto.materiais.map((m) => m.nome).join(', '),
            ),
  ...
  void _goToMyLocation() async {
    // In a real app, you would use the geolocator package to get the user's location
    // For now, we'll just animate to the default location
