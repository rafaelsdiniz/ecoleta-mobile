...
class _CollectionPointsScreenState extends State<CollectionPointsScreen> {
    ...
    return Card(
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              // Ícone pequeno do ponto de coleta
              Container(
                width: 60,
                height: 60,
                decoration: BoxDecoration(
  ...
  Widget _buildPointIcon(PontoColeta point) {
    // Se tem imagem Base64, exibe como ícone pequeno
    if (point.imagemBase64 != null && point.imagemBase64!.isNotEmpty) {
      try {
        final bytes = _decodeBase64(point.imagemBase64!);
        return ClipRRect(
          borderRadius: BorderRadius.circular(12),
          child: Image.memory(
            bytes,
            ...
            errorBuilder: (context, error, stackTrace) {
              return _buildDefaultPointIcon();
            },
          ),
        );
      } catch (e) {
        print('Error decoding base64 for point: $e');
        return _buildDefaultPointIcon();
      }
    }
    
    // Se tem URL de imagem, também exibe como ícone pequeno
    if (point.nomeImagem != null && point.nomeImagem!.isNotEmpty) {
      return ClipRRect(
        borderRadius: BorderRadius.circular(12),
        child: Image.network(
          point.imageUrl,
  ...
  Uint8List _decodeBase64(String base64String) {
    // Remove o prefixo se existir (data:image/png;base64,)
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Ícone do ponto na tela de detalhes (também pequeno)
                    Center(
                      child: Container(
                        width: 100,
                        height: 100,
